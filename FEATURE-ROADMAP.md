...
| FR-004 | Deliberately migrate the first-party native Gallery source to the current GLAZE UI V1.3 / 1.3.0 Adaptive Resonance authority using exact source anchors and governed semantic roles. | High | Development — Draft PR #74 exact head `85472206cc5aab479c3582c144574473ad4ae26a` passed Platform Contract `34529005727`, Native Android App `34529004725`, and Native Android Adapter `34529004728`. Stacked Draft PR #75 validated implementation revision `1e5f222bc8e4eef26afc8ab4735335d8e80463af` passed Native Android App `34538577156` and Native Android Adapter `34538577100` after correcting a test-harness-only `Files.readString` compatibility failure. Whole-application acceptance remains incomplete. |
...
| FR-006 | Complete first-party photo-editor acceptance for crop, rotate, flip, Reset, non-destructive Save copy, process recreation, orientation/output fidelity, metadata/color behavior, failure/cancellation cases, accessibility, and representative devices. | High | Development — Draft PR #75 maps ordinary editor target, spacing, and control/container shape inputs to the current V1.3 repository-local semantic contract and adds a source regression guard. Its validated implementation revision is `1e5f222bc8e4eef26afc8ab4735335d8e80463af`; rendered/device acceptance, output fidelity, and broader editor acceptance remain incomplete. |
