...
# Preserve the exact normalized text state used by the accepted gc.7 build.
...
printf 'Reconstructed GoreeCloud Gallery 1.0.0-gc.7 from pinned upstream revisions.\n'
